...
#if defined( ipconfigDHCP_USES_USER_HOOK ) || defined(ipconfigDHCP_CALLS_APPLICATION_HOOK )
	#error these defines and and their associated callback have been superceeded - see http://www.FreeRTOS.org/FreeRTOS-Plus/FreeRTOS_Plus_TCP/TCP_IP_Configuration.html#ipconfigUSE_DHCP_HOOK
#endif
