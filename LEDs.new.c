...
const uint32_t ulLEDs[ partstNUM_LEDS ] = { ALT_GPIO_BIT2, ALT_GPIO_BIT3, ALT_GPIO_BIT4, ALT_GPIO_BIT5 };
const uint32_t ulAllLEDs =                  ALT_GPIO_BIT2| ALT_GPIO_BIT3| ALT_GPIO_BIT4| ALT_GPIO_BIT5;
const uint32_t *pulPortBData = (uint32_t *) LED_PIO_BASE;//ALT_GPIO1_SWPORTA_DR_ADDR;
